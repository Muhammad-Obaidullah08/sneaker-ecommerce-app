    ...
    return (
        <>
            ...
            <div className="text-center">
                <h1 className="font-bold text-2xl sm:text-3xl lg:text-4xl mt-10 uppercase text-sky-950">Flex Fashion</h1>
            </div>
            ...
            <section className="flex flex-col md:flex-row justify-center items-center mt-5">
                <div className="flex justify-center items-center md:mx-5 md:w-1/2">
                    <Image src="/images/4.webp" alt="products" width={300} height={300} className="h-72 sm:h-80 w-60 sm:w-72 md:w-80"></Image>
                </div>
